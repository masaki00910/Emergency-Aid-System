...
const faqData: FAQItem[] = [
  ...
  {
    id: '11',
    question: '現在位置がずれて表示されるのはなぜですか？',
    answer: '本機能はブラウザの位置情報APIを利用しています。Wi-Fi接続時はアクセスポイントの情報に依存するため、実際の位置とずれる場合があります。位置情報が正しく取得できない場合は、スマホ経由でテザリング接続することで正しい位置情報を取得できます。',
    category: 'technical'
  }
]
